...
if __name__ == "__main__":
    ...
    for i in range(30):
        hill_climbing = HillClimbing(    
            funcao_fitness=lambda sol: knapsack.knapsack(sol, dim=DIM)[0],  # Maximizar valor total
    ...
    with open('./fitness/hillclimbing.txt', "w") as file:
